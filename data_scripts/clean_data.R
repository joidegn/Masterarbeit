...
# not enough time to solve this issue properly, we just grep the missing descriptions from the file. This is clumsy, slow and requires jq (the command line json parser to be installed)
...
# the following has been used for finding out variable names while writing the thesis
breaks.61.to.66 <- c("BBDE1.M.DE.W.AEA1.A2P310000.F.V.I10.A","BBDE1.M.DE.Y.AEA1.A2R200050.F.V.I10.A","BBDE1.M.DE.Y.BA01.A2P200000.F.C.I10.A","BBDE1.M.DE.Y.BAA1.A2P000000.G.C.I10.A","BOGMBASE","BOGNONBR","BUSLOANS","CEU0500000008","CEU1000000001","CPILFENS","CURRNS","FEDFUNDS","GS1","IPBUSEQ","IPDMAN","M1SL","NAPMNOI","PAYNSA","PPICRM","TB3MS","TB6MS","UMCSENT","USGOOD")
breaks.62.to.65 <- c("BBDE1.M.DE.W.AEA1.A2P310000.F.V.I10.A", "BBDE1.M.DE.Y.AEA1.A2R200050.F.V.I10.A", "BBDE1.M.DE.Y.BA01.A2P200000.F.C.I10.A", "BBDE1.M.DE.Y.BAA1.A2P000000.G.C.I10.A", "BOGMBASE", "BOGNONBR", "BUSLOANS", "CEU0500000008", "CEU1000000001", "CPILFENS", "CURRNS", "FEDFUNDS", "GS1", "IPBUSEQ", "M1SL", "NAPMNOI", "PPICRM", "TB3MS", "TB6MS", "UMCSENT")
breaks.25 <- c("BBK01.BU1132", "BBK01.EU2001", "BBK01.OU0149", "BBK01.OU1429", "BBK01.OU1825", "BBK01.XU4204", "BBK01.XX3739", "CEU3100000001")
all.breaks <- c("BBDE1.M.DE.W.AEA1.A2P310000.F.V.I10.A","BBDE1.M.DE.Y.AEA1.A2R200050.F.V.I10.A","BBDE1.M.DE.Y.BA01.A2P200000.F.C.I10.A","BBDE1.M.DE.Y.BAA1.A2P000000.G.C.I10.A","BBDE1.M.DE.Y.BEA1.P2XF00000.BA.P.ABA.A","BBDP1.M.DE.N.APA1.G.GP09SA000000.I10.A","BBDP1.M.DE.N.VPI.C.A00000.I10.L","BBEX3.M.XAU.USD.EA.AC.C06","BBK01.BU1132","BBK01.DU7802","BBK01.EU2001","BBK01.EU4170","BBK01.OU0092","BBK01.OU0144","BBK01.OU0149","BBK01.OU0337","BBK01.OU1429","BBK01.OU1825","BBK01.US0CC1","BBK01.XS7085","BBK01.XU4204","BBK01.XX3739","AAA","AHEMAN","BAA","BOGMBASE","BOGNONBR","BUSLOANS","BUSLOANSNSA","CCRETT01USM661N","CES0600000007","CEU0500000008","CEU1000000001","CEU2000000001","CEU3000000007","CEU3100000001","CPIAUCNS","CPILFENS","CPITRNNS","CURRNS","FEDFUNDS","GS1","GS5","HOUSTMWNSA","IPBUSEQ","IPDMAN","IPFINAL","IPMINE","LNU01000000","LNU01300000","M1SL","NAPM","NAPMII","NAPMNOI","NAPMPI","NAPMSDI","PAYNSA","PERMITNSA","PPICRM","TB3MS","TB6MS","TOTBUSIRNSA","UMCSENT","USGOOD")

best.performing.targeted.model <- c("BBK01.JQA000","BBDE1.M.DE.W.AEA1.A2P310000.F.V.I10.A","BBDE1.M.DE.Y.AEB1.N2C290000.F.C.I10.A","BBDE1.M.DE.Y.BAA1.A2P000000.G.C.I10.A","BBDE1.M.DE.Y.BEA1.P2XF00000.BA.P.ABA.A","BBK01.EU2001","BBK01.OU0092","BBK01.TVS303J","BBK01.TXI355","BBK01.WU0028","BBK01.XU4204","BBK01.XU4206","BBK01.XX3739","AHECONS","BUSLOANSNSA","CES0600000008","CES3000000008","CEU2000000001","CEU3200000001","CIVPART","CPIMEDNS","CURRNS","DGORDER","EXSZUS","HOUSTMWNSA","HOUSTW","IPFUELN","ISRATIO","LNU01300000","M1NS","M2NS","MICH","NDMANEMP","PPIFCF","RRSFS","TB6MS","TOTBUSIRNSA","UEMPMEAN","USCONS")
second.best.performing.targeted.model.removes <- c("BBK01.WU0028", "BBK01.XU4206", "CES3000000008", "CIVPART", "HOUSTW", "NDMANEMP", "PPIFCF")
third.best.performing.targeted.model.adds <- c("NAPMNOI")

variable.descriptions[best.performing.targeted.model]
variable.descriptions[second.best.performing.targeted.model.removes]
