...
This thesis deals with testing for structural breaks in factor models and using factor models for forecasting in a situation where structural breaks might be present.
...
The treatment of structural breaks follows \citet{breitung2011testing} closely.
...
Under heteroskedasticity regression has to be weighted by the covariance matrix. If we take account of the possibility of a break in the covariance matrix we get
